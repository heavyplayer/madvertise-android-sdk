...
# Add internet permissions (INTERNET) and *optionally* location (ACCESS_COARSE_LOCATION, ACCESS_FINE_LOCATION) wifi state (ACCESS_WIFI_STATE) or external storage (WRITE_EXTERNAL_STORAGE).
