...
!https://github.com/madvertise/madvertise-android-sdk/documentation/new_android_project_my_app.jpg!
...
!https://github.com/madvertise/madvertise-android-sdk/documentation/app_properties_reference.jpg!
...
* Finally, your manifest file should look something like this
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application android:icon="@drawable/icon" android:label="@string/app_name">
        ...
        <meta-data android:value="YOUR_TOKEN" android:name="madvertise_site_token" />
    </application>
...
<?xml version="1.0" encoding="utf-8"?>
<resources>
	<declare-styleable name = "de.madvertise.android.sdk.MadView">
		<attr name="secondsToRefresh" format="integer" />
		<attr name="backgroundColor" format="color" />
		<attr name="textSize" format="integer" />
		<attr name="textColor" format="color" />
		<attr name="isTestMode" format="boolean" />
...
* The layout file should look similiar to this
...
5. Create an "Issue":https://github.com/madvertise/madvertise-android-sdk/issues with a link to your branch
